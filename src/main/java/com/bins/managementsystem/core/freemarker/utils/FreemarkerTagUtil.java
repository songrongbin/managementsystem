package com.bins.managementsystem.core.freemarker.utils;
...
public class FreemarkerTagUtil {
	 ...
	 */
	public static Map<String, TemplateModel> setTemplateModel(Environment env, Map<String, TemplateModel> maps,Map<String, TemplateModel> origMap) throws
